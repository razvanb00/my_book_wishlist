...
class BookMockRepository{
  ...
  //   booklist.add(Book(2, "Tata bogat, tata sarac", "Robert Kiyosaki", "Educatie financiara in familie", FormatEnum.FIZIC));
  //   booklist.add(Book(3, "Un IQ financiar mai bun", "Robert Kiyosaki", "Invata cum sa-ti folosesti banii mai cu cap", FormatEnum.PDF));
